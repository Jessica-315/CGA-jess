...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(1.0, 0.0, 0.0)));//0.5, 0.5, 0.4
		shaderMulLighting.setFloat("density", 0.01);
		shaderMulLighting.setFloat("gradient", 0.6);
		shaderTerrain.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(1.0, 0.0, 0.0)));//0.5, 0.5, 0.4
