...
vec3 randomInitialVelocity() {
	...
	float phi = mix(0.0, 2.0 * PI, texelFetch(RandomTex, 3 * gl_VertexID + 1, 0).r);//texelFetch obtiene la textura de RandomTex con las coordenadas en 2d
	float velocity = mix(0.1, 0.9, texelFetch(RandomTex, 3 * gl_VertexID + 2, 0).r);
