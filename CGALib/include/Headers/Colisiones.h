...
//Las siguientes funciones las escribimos conforme al algoritmo del libro RayVsBox que está en drive, clase 20/05/2023
...
bool testRayOBB(glm::vec3 o, glm::vec3 t, AbstractModel::OBB collider) {
	...
	glm::vec3 cOBBTemp = qInv * collider.c; //cOBBTemp hace referencia al centro de la caja
	AbstractModel::AABB aabb;
